...
const TONE = { left: "crit", unknown: "warn", orphan: "warn", abandoned: "crit", rotate: "crit", unused: "warn" };
...
const SHORT = { left: "人已离职", unknown: "查不到人", orphan: "无主账号", abandoned: "号已删除", rotate: "该换密钥", unused: "闲置密钥" };
